...
public class NotePhotoDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhotoNote c = (PhotoNote) getIntent().getParcelableExtra("NOTE");
        photoImageViewp.setImageURI(c.getImage());
        photoNoteEditText.setText(c.getNote());
        background.setBackgroundColor(c.getColor());
